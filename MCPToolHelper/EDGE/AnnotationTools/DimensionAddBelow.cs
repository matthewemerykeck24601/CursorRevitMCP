...
// Type: EDGE.AnnotationTools.DimensionAddBelow
...
internal class DimensionAddBelow : IExternalCommand
{
  public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
  {
    ...
    string name = "Format Dimension: Add Text Below";
    ...
    using (Transaction transaction = new Transaction(document, name))
    {
      try
      {
        ...
        collectorFormDimText.label.Text = "Enter a Text String to add to the selected dimension string(s) in the Below position. \n \nAn empty string will reset the Below text string.";
        ...
        while (num1 == 1)
        {
          ...
          DimensionSegmentUtils.AddDimensionText("Below", upper);
