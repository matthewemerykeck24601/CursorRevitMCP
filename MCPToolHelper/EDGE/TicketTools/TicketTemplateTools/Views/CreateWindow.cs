...
// Type: EDGE.TicketTools.TicketTemplateTools.Views.CreateWindow
...
public class CreateWindow : Window, IComponentConnector
{
  ...
  public CreateWindow()
  {
    ...
    this.DataContext = (object) new TicketCreateWindowViewModel();
  }
  ...
  public CreateWindow(
    ...
    string sourceSheet,
    TicketTemplateCreatorViewModel tempViewModel)
  {
    this.InitializeComponent();
    this.DataContext = (object) new TicketCreateWindowViewModel(this, templateName, constructionProduct, sourceSheet, tempViewModel);
  }
  ...
  public CreateWindow(
    ...
    string constructionProduct,
    string sourceSheet,
    HWTemplateCreatorViewModel tempHWViewModel)
  {
    this.InitializeComponent();
    this.DataContext = (object) new HWCreateWindowViewModel(this, templateName, constructionProduct, sourceSheet, (TemplateCreatorViewModel) tempHWViewModel);
  }
  ...
  public void InitializeComponent()
  {
    ...
    Application.LoadComponent((object) this, new Uri("/EDGEforREVIT;component/tickettools/tickettemplatetools/views/createwindow.xaml", UriKind.Relative));
  }
