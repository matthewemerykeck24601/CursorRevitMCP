...
// Type: EDGE.InsulationTools.InsulationRemoval.InsulationRemovalActiveView
...
public class InsulationRemovalActiveView
{
  public static Result ActiveView(Document revitDoc)
  {
    ...
    using (TransactionGroup transactionGroup = new TransactionGroup(revitDoc, "Insulation Removal - Active View"))
    {
      ...
      List<Element> elements = EDGE.InsulationTools.InsulationRemoval.UtilityFunctions.InsulationRemoval.RetrieveValidSFPieces(new FilteredElementCollector(revitDoc, revitDoc.ActiveView.Id).WherePasses((ElementFilter) filter).ToList<Element>());
