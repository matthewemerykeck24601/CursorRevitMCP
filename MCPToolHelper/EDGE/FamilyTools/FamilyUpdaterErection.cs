...
// Type: EDGE.FamilyTools.FamilyUpdaterErection
...
internal class FamilyUpdaterErection : IExternalCommand
{
  public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
  {
    ...
    {
      new TaskDialog("Erection Family Parameter Updater")
      {
    ...
    using (Transaction transaction = new Transaction(document, "Update Erection Family (Loose Items) Parameters"))
    {
      if (!str.Equals("Structural Framing"))
      {
        try
        {
          ...
          taskDialog.Id = "ID_Erection_Family_Updater";
          taskDialog.MainIcon = (TaskDialogIcon) (int) ushort.MaxValue;
          taskDialog.Title = "Erection Family Updater";
          taskDialog.TitleAutoPrefix = true;
          taskDialog.AllowCancellation = true;
          taskDialog.MainInstruction = "Erection Family (Loose Item) Updater";
          taskDialog.MainContent = "Choose the type of Erection Family (Loose Item) to update";
          taskDialog.FooterText = "EDGE^R 2024 12.2.0 (build date: 2025.06.10)";
          taskDialog.ExpandedContent = "This tool updates existing Embed families with previous version parameters to the current version of EDGE^R.  This tool is also useful to create a new family from a blank template with the proper parameters, or to convert a family from one Manufacture Component type to that of Erection.";
          taskDialog.AddCommandLink((TaskDialogCommandLinkId) 1001, "This is a Precaster Standard Erection Family (Loose Item).");
          taskDialog.AddCommandLink((TaskDialogCommandLinkId) 1002, "This is a Custom Erection Family (Loose Item) for my project.");
          taskDialog.AddCommandLink((TaskDialogCommandLinkId) 1003, "This is a Manufactured Part Erection Family (Loose Item).");
          ...
          if (taskDialogResult == 1001)
          {
            ...
            string aManufactureComponent = "ERECTION STANDARD";
          ...
          if (taskDialogResult == 1002)
          {
            ...
            string aManufactureComponent = "ERECTION CUSTOM";
            if (new TaskDialog("Finishes")
            {
              MainInstruction = "Does this family use Finishes?",
              CommonButtons = ((TaskDialogCommonButtons) 6),
          ...
          string aManufactureComponent1 = "ERECTION MANUFACTURED PRODUCT";
          if (new TaskDialog("Finishes")
          {
            MainInstruction = "Does this family use Finishes?",
            CommonButtons = ((TaskDialogCommonButtons) 6),
