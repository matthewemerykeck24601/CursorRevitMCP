...
// Type: EDGE.FamilyTools.FamilyUpdaterRebar
...
public class FamilyUpdaterRebar : IExternalCommand
{
  public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
  {
    ...
    string str1 = "Rebar Family Parameter Updater";
    ...
    using (Transaction transaction = new Transaction(document, "Update Rebar Family Parameters"))
    {
      if (!str3.Equals("Structural Framing"))
      {
        try
        {
          ...
          taskDialog.Id = "ID_Rebar_Family_Updater";
          taskDialog.MainIcon = (TaskDialogIcon) (int) ushort.MaxValue;
          taskDialog.Title = "Rebar Family Updater";
          taskDialog.TitleAutoPrefix = true;
          taskDialog.AllowCancellation = true;
          taskDialog.MainInstruction = "Rebar Family Updater";
          taskDialog.MainContent = "Choose the type of Rebar family to update";
          taskDialog.FooterText = "EDGE^R 2024 12.2.0 (build date: 2025.06.10)";
          taskDialog.ExpandedContent = "This tool updates existing Rebar Family with previous version parameters to the current version of EDGE^R.  This tool is also useful to create a new family from a blank template with the proper parameters.";
          taskDialog.AddCommandLink((TaskDialogCommandLinkId) 1001, "This is a Precaster Standard Rebar Family.");
          taskDialog.AddCommandLink((TaskDialogCommandLinkId) 1002, "This is a Custom Rebar Family for my project.");
          taskDialog.AddCommandLink((TaskDialogCommandLinkId) 1003, "This is a Spiral Wire Rebar Family.");
          ...
          if (taskDialogResult == 1001)
          {
            ...
            string aManufactureComponent = "REBAR STANDARD";
            Result result = FamUpdaterRebar.RebarParameters(application, aFilePath, aManufactureComponent);
          ...
          if (taskDialogResult == 1002)
          {
            ...
            string aManufactureComponent = "REBAR CUSTOM";
            Result result = FamUpdaterRebar.RebarParameters(application, aFilePath, aManufactureComponent);
          ...
          string aManufactureComponent1 = "REBAR SPIRAL";
          FamUpdaterMethods.UpdateStandardParameters(application, aFilePath, false, aManufactureComponent1);
