...
// Type: EDGE.TicketTools.TicketManager.Views.EditTitleblockViewModel
...
public class EditTitleblockViewModel : INotifyPropertyChanged
{
  ...
  private EditTitleblockWindow parentWindow;
  ...
  public EditTitleblockViewModel()
  {
  }

  public EditTitleblockViewModel(EditTitleblockWindow window, List<ComboBoxItemString> titleblocks)
  {
