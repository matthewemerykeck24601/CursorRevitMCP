...
// Type: EDGE.TicketTools.CheckFlagger.NeedRevAllCommand
...
public class NeedRevAllCommand : IExternalCommand
{
  public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
  {
    ...
    if (!FlaggerUtils.SetNeedsRevAll(activeUiDocument, true, assemblies))
      return (Result) 1;
    TaskDialog successDialog = CheckFlaggerToolUtils.GenerateSuccessDialog(assemblies);
    successDialog.Title = "Needs Revision All";
    successDialog.MainContent = "Revision requested for all selected assemblies. Expand for details";
    successDialog.Show();
    return (Result) 0;
  }
}
