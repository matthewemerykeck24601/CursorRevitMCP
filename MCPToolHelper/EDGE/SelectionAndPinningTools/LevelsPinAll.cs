...
// Type: EDGE.SelectionAndPinningTools.LevelsPinAll
...
internal class LevelsPinAll : IExternalCommand
{
  public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
  {
    ...
    if (!ModelLockingUtils.ShowPermissionsDialog(document, ModelLockingToolPermissions.PinUnpin))
      return (Result) 1;
    using (Transaction transaction = new Transaction(document, "Pin All Levels"))
    {
      try
      {
