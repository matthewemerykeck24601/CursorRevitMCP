...
// Type: EDGE.FamilyTools.FamilyUpdaterInsulation
...
public class FamilyUpdaterInsulation : IExternalCommand
{
  public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
  {
    ...
    string str1 = "Insulation Family Parameter Updater";
    ...
    using (Transaction transaction = new Transaction(document, "Update Insulation Family Parameters"))
    {
      if (!str3.Equals("Structural Framing"))
      {
        try
        {
          ...
          taskDialog.Id = "ID_Insulation_Family_Updater";
          taskDialog.MainIcon = (TaskDialogIcon) (int) ushort.MaxValue;
          taskDialog.Title = "Insulation Family Updater";
          taskDialog.TitleAutoPrefix = true;
          taskDialog.AllowCancellation = true;
          taskDialog.MainInstruction = "Insulation Family Updater";
          taskDialog.MainContent = "Choose the type of Insulation family to update";
          taskDialog.FooterText = "EDGE^R 2024 12.2.0 (build date: 2025.06.10)";
          taskDialog.ExpandedContent = "This tool updates existing Insulation Family with previous version parameters to the current version of EDGE^R.  This tool is also useful to create a new family from a blank template with the proper parameters.";
          taskDialog.AddCommandLink((TaskDialogCommandLinkId) 1001, "This is a Precaster Standard Insulation Family.");
          taskDialog.AddCommandLink((TaskDialogCommandLinkId) 1002, "This is a Custom Insulation Family for my project.");
          ...
          if (taskDialogResult == 1001)
          {
            ...
            string aManufactureComponent = "INSULATION STANDARD";
          ...
          string aManufactureComponent1 = "INSULATION CUSTOM";
