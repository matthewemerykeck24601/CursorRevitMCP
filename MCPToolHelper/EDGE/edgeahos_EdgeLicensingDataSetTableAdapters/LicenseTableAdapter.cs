...
// Type: EDGE.edgeahos_EdgeLicensingDataSetTableAdapters.LicenseTableAdapter
...
public class LicenseTableAdapter : Component
{
  ...
  public virtual int Fill(
    edgeahos_EdgeLicensingDataSet.LicenseDataTable dataTable)
  {
  ...
  public virtual edgeahos_EdgeLicensingDataSet.LicenseDataTable GetData()
  {
    this.Adapter.SelectCommand = this.CommandCollection[0];
    edgeahos_EdgeLicensingDataSet.LicenseDataTable data = new edgeahos_EdgeLicensingDataSet.LicenseDataTable();
