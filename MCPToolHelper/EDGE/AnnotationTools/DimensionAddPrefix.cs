...
// Type: EDGE.AnnotationTools.DimensionAddPrefix
...
internal class DimensionAddPrefix : IExternalCommand
{
  public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
  {
    ...
    string name = "Format Dimension: Add Text Prefix";
    ...
    using (Transaction transaction = new Transaction(document, name))
    {
      try
      {
        ...
        collectorFormDimText.label.Text = "Enter a Text String to add to the selected dimension string(s) in the Prefix position. \n \nAn empty string will reset the Prefix text string.";
        ...
        while (num1 == 1)
        {
          ...
          DimensionSegmentUtils.AddDimensionText("Prefix", upper);
