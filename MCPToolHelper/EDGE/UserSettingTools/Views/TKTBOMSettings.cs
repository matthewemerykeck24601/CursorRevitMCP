...
// Type: EDGE.UserSettingTools.Views.TKTBOMSettings
...
public class TKTBOMSettings
{
  public List<ItemEntry> TicketBOMList = new List<ItemEntry>();
  ...
  public bool SaveTempalteSettings(string fileSavePath)
  {
    ...
    try
    {
      XmlSerializer xmlSerializer = new XmlSerializer(typeof (TKTBOMSettings));
  ...
  public bool LoadTicketTemplateSettings(string fileOpenPath)
  {
    ...
    try
    {
      ...
      TKTBOMSettings tktbomSettings = (TKTBOMSettings) xmlSerializer.Deserialize((Stream) fileStream);
      if (tktbomSettings.TicketBOMList == null || !tktbomSettings.TicketBOMList.Any<ItemEntry>())
        return true;
      this.TicketBOMList.AddRange((IEnumerable<ItemEntry>) tktbomSettings.TicketBOMList);
      return true;
    }
    catch (Exception ex)
    {
