...
// Type: EDGE.FamilyTools.FamilyUpdaterCast
...
internal class FamilyUpdaterCast : IExternalCommand
{
  public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
  {
    ...
    string str1 = "Cast Family (CIP) Parameter Updater";
    ...
    using (Transaction transaction = new Transaction(document, "Update Cast Family (CIP) Parameters"))
    {
      if (!str3.Equals("Structural Framing"))
      {
        try
        {
          ...
          taskDialog.Id = "ID_Cast_Family_Updater";
          taskDialog.MainIcon = (TaskDialogIcon) (int) ushort.MaxValue;
          taskDialog.Title = "Cast Family (CIP) Updater";
          taskDialog.TitleAutoPrefix = true;
          taskDialog.AllowCancellation = true;
          taskDialog.MainInstruction = "Cast Family (CIP) Updater";
          taskDialog.MainContent = "Choose the type of Cast family to update";
          taskDialog.FooterText = "EDGE^R 2024 12.2.0 (build date: 2025.06.10)";
          taskDialog.ExpandedContent = "This tool updates existing Embed families with previous version parameters to the current version of EDGE^R.  This tool is also useful to create a new family from a blank template with the proper parameters, or to convert a family from one Manufacture Component type to that of Cast-In-Place.";
          taskDialog.AddCommandLink((TaskDialogCommandLinkId) 1001, "This is a Precaster Standard Cast Family (CIP).");
          taskDialog.AddCommandLink((TaskDialogCommandLinkId) 1002, "This is a Custom Cast Family (CIP) for my project.");
          taskDialog.AddCommandLink((TaskDialogCommandLinkId) 1003, "This is a Manufactured Part Cast Family (CIP).");
          ...
          if (taskDialogResult == 1001)
          {
            ...
            string aManufactureComponent = "CIP STANDARD";
          ...
          if (taskDialogResult == 1002)
          {
            ...
            string aManufactureComponent = "CIP CUSTOM";
            if (new TaskDialog("Finishes")
            {
              MainInstruction = "Does this family use Finishes?",
              CommonButtons = ((TaskDialogCommonButtons) 6),
          ...
          string aManufactureComponent1 = "CIP MANUFACTURED PRODUCT";
          if (new TaskDialog("Finishes")
          {
            MainInstruction = "Does this family use Finishes?",
            CommonButtons = ((TaskDialogCommonButtons) 6),
