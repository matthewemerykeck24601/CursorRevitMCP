...
// Type: EDGE.SelectionAndPinningTools.GridsUnpinAll
...
internal class GridsUnpinAll : IExternalCommand
{
  public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
  {
    ...
    if (!ModelLockingUtils.ShowPermissionsDialog(document, ModelLockingToolPermissions.PinUnpin))
      return (Result) 1;
    using (Transaction transaction = new Transaction(document, "Unpin All Grids"))
    {
      try
      {
