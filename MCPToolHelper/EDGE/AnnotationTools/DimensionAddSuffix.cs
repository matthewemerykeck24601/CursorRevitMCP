...
// Type: EDGE.AnnotationTools.DimensionAddSuffix
...
internal class DimensionAddSuffix : IExternalCommand
{
  public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
  {
    ...
    string name = "Format Dimension: Add Text Suffix";
    ...
    using (Transaction transaction = new Transaction(document, name))
    {
      try
      {
        ...
        collectorFormDimText.label.Text = "Enter a Text String to add to the selected dimension string(s) in the Suffix position. \n \nAn empty string will reset the Suffix text string.";
        ...
        while (num1 == 1)
        {
          ...
          DimensionSegmentUtils.AddDimensionText("Suffix", upper);
