...
// Type: EDGE.FamilyTools.FamilyUpdaterLift
...
internal class FamilyUpdaterLift : IExternalCommand
{
  public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
  {
    ...
    string str1 = "Lifting and Handling Family Parameter Updater";
    ...
    using (Transaction transaction = new Transaction(document, "Update Lifting and Handling Family Parameters"))
    {
      if (!str3.Equals("Structural Framing"))
      {
        try
        {
          ...
          taskDialog.Id = "ID_Lift_Family_Updater";
          taskDialog.MainIcon = (TaskDialogIcon) (int) ushort.MaxValue;
          taskDialog.Title = "Lifting and Handling Family Updater";
          taskDialog.TitleAutoPrefix = true;
          taskDialog.AllowCancellation = true;
          taskDialog.MainInstruction = "Lifting and Handling Family Updater";
          taskDialog.MainContent = "Choose the type of Lifting and Handling family to update";
          taskDialog.FooterText = "EDGE^R 2024 12.2.0 (build date: 2025.06.10)";
          taskDialog.ExpandedContent = "This tool updates existing Lifting and Handling Family with previous version parameters to the current version of EDGE^R.  This tool is also useful to create a new family from a blank template with the proper parameters, or to convert a family from one Manufacture Component type to that of Embed.";
          taskDialog.AddCommandLink((TaskDialogCommandLinkId) 1001, "This is a Precaster Standard Lifting and Handling Family.");
          taskDialog.AddCommandLink((TaskDialogCommandLinkId) 1002, "This is a Custom Lifting and Handling Family for my project.");
          taskDialog.AddCommandLink((TaskDialogCommandLinkId) 1003, "This is a Manufactured Part Lifting and Handling Family.");
          ...
          if (taskDialogResult == 1001)
          {
            ...
            string aManufactureComponent = "LIFTING STANDARD";
          ...
          if (taskDialogResult == 1002)
          {
            ...
            string aManufactureComponent = "LIFTING CUSTOM";
            if (new TaskDialog("Finishes")
            {
              MainInstruction = "Does this family use Finishes?",
              CommonButtons = ((TaskDialogCommonButtons) 6),
          ...
          string aManufactureComponent1 = "LIFTING MANUFACTURED PRODUCT";
          if (new TaskDialog("Finishes")
          {
            MainInstruction = "Does this family use Finishes?",
            CommonButtons = ((TaskDialogCommonButtons) 6),
