...
// Type: EDGE.edgeahos_EdgeLicensingDataSetTableAdapters.TableAdapterManager
...
public class TableAdapterManager : Component
{
  ...
  {
    get => this._licensesTableAdapter;
    set => this._licensesTableAdapter = value;
  }
  ...
  public IDbConnection Connection
  {
    get
    {
      ...
      if (this._licensesTableAdapter != null && this._licensesTableAdapter.Connection != null)
        return (IDbConnection) this._licensesTableAdapter.Connection;
  ...
  private int UpdateUpdatedRows(
    edgeahos_EdgeLicensingDataSet dataSet,
    ...
    List<DataRow> allAddedRows)
  {
    ...
    if (this._licensesTableAdapter != null)
    {
      DataRow[] realUpdatedRows = this.GetRealUpdatedRows(dataSet.Licenses.Select((string) null, (string) null, DataViewRowState.ModifiedCurrent), allAddedRows);
      if (realUpdatedRows != null && realUpdatedRows.Length != 0)
      {
        num += this._licensesTableAdapter.Update(realUpdatedRows);
        allChangedRows.AddRange((IEnumerable<DataRow>) realUpdatedRows);
      }
    }
    if (this._machinesTableAdapter != null)
  ...
  [DebuggerNonUserCode]
  [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
  private int UpdateInsertedRows(edgeahos_EdgeLicensingDataSet dataSet, List<DataRow> allAddedRows)
  {
    int num = 0;
    if (this._licenseTableAdapter != null)
    {
    ...
    if (this._licensesTableAdapter != null)
    {
      DataRow[] dataRowArray = dataSet.Licenses.Select((string) null, (string) null, DataViewRowState.Added);
      if (dataRowArray != null && dataRowArray.Length != 0)
      {
        num += this._licensesTableAdapter.Update(dataRowArray);
        allAddedRows.AddRange((IEnumerable<DataRow>) dataRowArray);
      }
    }
    if (this._machinesTableAdapter != null)
  ...
  [DebuggerNonUserCode]
  [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
  private int UpdateDeletedRows(edgeahos_EdgeLicensingDataSet dataSet, List<DataRow> allChangedRows)
  {
    int num = 0;
    if (this._machinesTableAdapter != null)
    {
    ...
    if (this._licensesTableAdapter != null)
    {
      DataRow[] dataRowArray = dataSet.Licenses.Select((string) null, (string) null, DataViewRowState.Deleted);
      if (dataRowArray != null && dataRowArray.Length != 0)
      {
        num += this._licensesTableAdapter.Update(dataRowArray);
        allChangedRows.AddRange((IEnumerable<DataRow>) dataRowArray);
  ...
  [DebuggerNonUserCode]
  [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
  public virtual int UpdateAll(edgeahos_EdgeLicensingDataSet dataSet)
  {
    if (dataSet == null)
    ...
    if (this._licensesTableAdapter != null && !this.MatchTableAdapterConnection((IDbConnection) this._licensesTableAdapter.Connection))
      throw new ArgumentException("All TableAdapters managed by a TableAdapterManager must use the same connection string.");
    ...
    try
    {
      ...
      if (this._licensesTableAdapter != null)
      {
        dictionary.Add((object) this._licensesTableAdapter, (IDbConnection) this._licensesTableAdapter.Connection);
        this._licensesTableAdapter.Connection = (SqlConnection) connection;
        this._licensesTableAdapter.Transaction = (SqlTransaction) dbTransaction;
        if (this._licensesTableAdapter.Adapter.AcceptChangesDuringUpdate)
        {
          ...
          dataAdapterList.Add((DataAdapter) this._licensesTableAdapter.Adapter);
        }
      }
      if (this._machinesTableAdapter != null)
      {
    ...
    finally
    {
      ...
      if (this._licensesTableAdapter != null)
      {
        this._licensesTableAdapter.Connection = (SqlConnection) dictionary[(object) this._licensesTableAdapter];
        this._licensesTableAdapter.Transaction = (SqlTransaction) null;
      }
      if (this._machinesTableAdapter != null)
      {
