...
// Type: EDGE.UserSettingTools.Views.TitleBlockPopulatorSettingWindow
...
public class TitleBlockPopulatorSettingWindow : Window, IComponentConnector
{
  ...
  public TitleBlockPopulatorSettingWindow(
    Document revitDoc,
    ...
    out bool ifContinue)
  {
    ...
    {
      ifContinue = false;
      int num = (int) System.Windows.MessageBox.Show("Title Block Poplulator Setting Dialog cannot be used in the family view, transaction will be cancelled.");
    }
    else
    {
      ...
      while (bindingMapIterator1.MoveNext())
      {
        ...
        if (current1 != null)
        {
          ...
          {
            if (category.Name.Equals("Assemblies") || category.Name.Equals("Structural Framing"))
      ...
      this.path = string.IsNullOrEmpty(App.TBPopFolderPath) ? $"C:/EDGEforREVIT/{this.manufacturerName}_TitleBlock_Mapping.xml" : $"{App.TBPopFolderPath}\\{this.manufacturerName}_TitleBlock_Mapping.xml";
      ...
      {
        this.listToShow.Add(new DatagridItemEntry("DIM_LENGTH", "TKT_LENGTH", false));
        this.listToShow.Add(new DatagridItemEntry("DIM_WIDTH/DIM_HEIGHT", "TKT_WIDTH", false));
        this.listToShow.Add(new DatagridItemEntry("DIM_DEPTH/DIM_THICKNESS", "TKT_DEPTH", false));
        this.listToShow.Add(new DatagridItemEntry("First architectural precast material volume", "TKT_ARCH_VOL_1", false));
        this.listToShow.Add(new DatagridItemEntry("Second architectural precast material volume", "TKT_ARCH_VOL_2", false));
        this.listToShow.Add(new DatagridItemEntry("Third architectural precast material volume", "TKT_ARCH_VOL_3", false));
        this.listToShow.Add(new DatagridItemEntry("Fourth architectural precast material volume", "TKT_ARCH_VOL_4", false));
        this.listToShow.Add(new DatagridItemEntry("Sum of TKT_ARCH_VOL_1, TKT_ARCH_VOL_2, TKT_ARCH_VOL_3 and TKT_ARCH_VOL_4", "TKT_ARCH_VOL_TOT", false));
        this.listToShow.Add(new DatagridItemEntry("PRECAST CONCRETE volume", "TKT_STRUCT_CUYDS", false));
        this.listToShow.Add(new DatagridItemEntry("Quantity of structural framing elements that share the same CONTROL_MARK", "TKT_TOTAL_REQUIRED", false));
        this.listToShow.Add(new DatagridItemEntry("Precast element's total volume in project units", "TKT_CUYDS", false));
        this.listToShow.Add(new DatagridItemEntry("Weight Value in project unit", "TKT_WEIGHT", false));
        this.listToShow.Add(new DatagridItemEntry("Precast element's total volume in project units multiply WEIGHT_PER_UNIT", "TKT_WT", false));
  ...
  public void InitializeComponent()
  {
    ...
    System.Windows.Application.LoadComponent((object) this, new Uri("/EDGEforREVIT;component/usersettingtools/views/titleblockpopulatorsettingwindow.xaml", UriKind.Relative));
  }
