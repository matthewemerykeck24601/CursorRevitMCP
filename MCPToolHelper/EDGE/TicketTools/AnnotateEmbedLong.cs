...
// Type: EDGE.TicketTools.AnnotateEmbedLong
...
internal class AnnotateEmbedLong : IExternalCommand
{
  public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
  {
    ...
    while (true)
    {
      ...
      AnnotateEmbedLong.Execute(document, activeUiDocument, element, document.ActiveView);
    }
  }

  public static Result Execute(Document doc, UIDocument uidoc, Element selectedElem, View view)
  {
    string name1 = "IDENTITY_DESCRIPTION_SHORT";
    string name2 = "IDENTITY_DESCRIPTION";
    ...
    using (Transaction transaction = new Transaction(doc, "Annotate Embed Long"))
    {
      try
      {
        int num1 = (int) transaction.Start();
        Parameter parameter1 = selectedElem.LookupParameter(name1);
        string str1 = "";
        if (parameter1 == null)
        {
          str1 = "";
          parameter1 = doc.GetElement(selectedElem.GetTypeId()).LookupParameter(name1);
          if (parameter1 == null)
            str1 = "";
        }
        if (parameter1 != null)
          str1 = parameter1.AsString();
        Parameter parameter2 = selectedElem.LookupParameter(name2);
        string str2 = "";
        if (parameter2 == null)
        {
          str2 = "";
          parameter2 = doc.GetElement(selectedElem.GetTypeId()).LookupParameter(name2);
          if (parameter2 == null)
            str2 = "";
        }
        if (parameter2 != null)
        ...
        {
          TaskDialog.Show("Error", "Error:  The selected Element has no IDENTITY_DESCRIPTION_SHORT or IDENTITY_DESCRIPTION Parameter values. Press \"Close\" below to continue annotating.");
          int num2 = (int) transaction.RollBack();
          return (Result) 1;
        }
        TextNote textNote = TextNote.Create(doc, view.Id, position, 0.1, text, new TextNoteOptions()
        {
