...
// Type: EDGE.FamilyTools.FamilyUpdaterStemMesh
...
public class FamilyUpdaterStemMesh : IExternalCommand
{
  public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
  {
    ...
    {
      new TaskDialog("Stem Mesh Family Parameter Updater")
      {
    ...
    using (Transaction transaction = new Transaction(document, "Update Stem Mesh Family Parameters"))
    {
      if (!str.Equals("Structural Framing"))
      {
        try
        {
          ...
          taskDialog.Id = "ID_Stem_Mesh_Family_Updater";
          taskDialog.MainIcon = (TaskDialogIcon) (int) ushort.MaxValue;
          taskDialog.Title = "Stem Mesh Family Updater";
          taskDialog.TitleAutoPrefix = true;
          taskDialog.AllowCancellation = true;
          taskDialog.MainInstruction = "Stem Mesh Family Updater";
          taskDialog.MainContent = "Choose the type of Stem Mesh Family to update";
          taskDialog.FooterText = "EDGE^R 2024 12.2.0 (build date: 2025.06.10)";
          taskDialog.ExpandedContent = "This tool updates existing Stem Mesh Family with previous version parameters to the current version of EDGE^R.  This tool is also useful to create a new family from a blank template with the proper parameters.";
          taskDialog.AddCommandLink((TaskDialogCommandLinkId) 1001, "This is a Precaster Standard Stem Mesh Family.");
          taskDialog.AddCommandLink((TaskDialogCommandLinkId) 1002, "This is a Custom Stem Mesh Family for my project.");
          ...
          if (taskDialogResult == 1001)
          {
            ...
            string aManufactureComponent = "STEM MESH STANDARD";
          ...
          string aManufactureComponent1 = "STEM MESH CUSTOM";
