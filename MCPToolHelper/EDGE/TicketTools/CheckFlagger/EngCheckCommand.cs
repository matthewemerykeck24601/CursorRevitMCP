...
// Type: EDGE.TicketTools.CheckFlagger.EngCheckCommand
...
public class EngCheckCommand : IExternalCommand
{
  public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
  {
    ...
    if (!FlaggerUtils.CheckAll(activeUiDocument, InfoType.EngCheck, CheckFlaggerToolUtils.GetUsername(document), assemblies))
      return (Result) 1;
    TaskDialog successDialog = CheckFlaggerToolUtils.GenerateSuccessDialog(assemblies);
    successDialog.Title = "Engineering Check All";
    successDialog.MainContent = "Engineering Check applied to all selected assemblies. Expand for details";
    successDialog.Show();
    return (Result) 0;
  }
}
