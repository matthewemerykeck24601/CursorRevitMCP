...
// Type: EDGE.TicketTools.TemplateToolsBase.TemplateSettings
...
public class TemplateSettings
{
  ...
  public bool SaveTempalteSettings(
    string fileSavePath,
    ObservableCollection<ComboBoxItemString> manuList = null)
  {
    ...
    try
    {
      XmlSerializer xmlSerializer = new XmlSerializer(typeof (TemplateSettings));
  ...
  public bool LoadTicketTemplateSettings(string fileOpenPath)
  {
    ...
    try
    {
      ...
      TemplateSettings templateSettings = (TemplateSettings) xmlSerializer.Deserialize((Stream) fileStream);
