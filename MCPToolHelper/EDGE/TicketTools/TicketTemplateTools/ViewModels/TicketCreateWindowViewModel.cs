...
// Type: EDGE.TicketTools.TicketTemplateTools.ViewModels.TicketCreateWindowViewModel
...
internal class TicketCreateWindowViewModel : CreateWindowViewModel
{
  public TicketCreateWindowViewModel()
  {
  }
    ...
    TicketTemplateCreatorViewModel tempViewModel)
  {
    ...
    this.templateCreatorViewModel = (TemplateCreatorViewModel) tempViewModel;
  }
}
