...
// Type: EDGE.edgeahos_EdgeLicensingDataSetTableAdapters.MachinesTableAdapter
...
public class MachinesTableAdapter : Component
{
  ...
  public virtual int Fill(
    edgeahos_EdgeLicensingDataSet.MachinesDataTable dataTable)
  {
  ...
  public virtual edgeahos_EdgeLicensingDataSet.MachinesDataTable GetData()
  {
    this.Adapter.SelectCommand = this.CommandCollection[0];
    edgeahos_EdgeLicensingDataSet.MachinesDataTable data = new edgeahos_EdgeLicensingDataSet.MachinesDataTable();
